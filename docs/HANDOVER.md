...
> セッションをまたいで再開するための現在地まとめ。最終更新: 2026-06-12（S6 コード・テスト完了時点）。
...
| **S6** | **Gemini 台本生成 + DJ 二人の会話コーナー** | 🚧 コード・テスト完了。残: API キー設定 → モデル ID 実在確認 → ライブ確認 |

`swift test` = **117 件グリーン**。仕様 = `docs/specs/s6-gemini-dialogue-corner.md` / Confluence S6=38731777。
