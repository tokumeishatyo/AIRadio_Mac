...
> セッションをまたいで再開するための現在地まとめ。最終更新: 2026-06-12（S7 完了時点）。
...
| **S8** | **候補: メニューバー UI（開始/停止）/ ニュースの LLM 会話化 / 番組の連続ループ（ユーザーと相談して決める）** | ⏭ 次 |

`swift test` = **135 件グリーン**。仕様 = `docs/specs/s7-broadcast-engine.md` / Confluence S7=38895618（S6=38731777）。
